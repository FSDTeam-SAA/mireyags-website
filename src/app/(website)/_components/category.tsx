        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
          {features.map((feature) => {
            ...
            return (
              <Card
                key={feature.id}
                className="group overflow-hidden rounded-xl border border-white/20 bg-black shadow-none transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-white/40"
              >
                <CardContent className="p-0">
                  ...
                  <div className="flex flex-col items-center px-5 pb-6 pt-4 text-center">
                    ...
                    <h3 className="mt-4 text-[28px] font-semibold leading-tight text-white md:text-[30px]">
                      {feature.title}
                    </h3>

                    <p className="mt-2 max-w-[220px] text-sm leading-6 text-white/70">
                      {feature.description}
                    </p>
                  </div>
                </CardContent>
